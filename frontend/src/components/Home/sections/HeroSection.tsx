    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        <Box sx={{ maxWidth: { xs: '100%', md: '65%' } }}>
          <Typography
            variant="overline"
            sx={{ color: 'text.secondary', letterSpacing: '0.18em', mb: 2, display: 'block' }}
          >
          ...
          >
            AI-powered recommendations, exclusive promotions, and everything you need to build
            your perfect PC — all in one place.
          </Typography>
